...
*
* History:
* KBDTOOL v3.40 - Created  Sun Oct 03 16:03:44 2021
\***************************************************************************/
...
//                      |=========|=========|=========|=========|=========|
  {'9'          ,CAPLOK ,'$'      ,'9'      ,WCH_NONE ,WCH_NONE ,WCH_NONE },
  {'3'          ,CAPLOK ,'*'      ,'3'      ,WCH_NONE ,0x00d7   ,0x00f7   },
  {'1'          ,CAPLOK ,'+'      ,'1'      ,WCH_NONE ,WCH_NONE ,WCH_NONE },
  {'5'          ,CAPLOK ,'!'      ,'5'      ,WCH_NONE ,0x00a1   ,WCH_NONE },
  {'7'          ,CAPLOK ,'('      ,'7'      ,WCH_NONE ,WCH_NONE ,WCH_NONE },
  {'6'          ,CAPLOK ,')'      ,'6'      ,WCH_NONE ,WCH_NONE ,WCH_NONE },
  {'2'          ,CAPLOK ,'%'      ,'2'      ,WCH_NONE ,WCH_NONE ,WCH_NONE },
  {'0'          ,CAPLOK ,'?'      ,'0'      ,WCH_NONE ,0x00bf   ,WCH_NONE },
  {'4'          ,CAPLOK ,'\"'     ,'4'      ,WCH_NONE ,WCH_NONE ,WCH_NONE },
  {'8'          ,CAPLOK ,'&'      ,'8'      ,WCH_NONE ,WCH_NONE ,WCH_NONE },
  {VK_OEM_4     ,0      ,'['      ,'{'      ,WCH_NONE ,'<'      ,WCH_NONE },
  {VK_OEM_6     ,0      ,']'      ,'}'      ,WCH_NONE ,'>'      ,WCH_NONE },
  {'J'          ,CAPLOK ,'j'      ,'J'      ,WCH_NONE ,WCH_NONE ,WCH_NONE },
  {'G'          ,CAPLOK  | CAPLOKALTGR,'g'     ,'G'      ,WCH_NONE ,'k'      ,'K'      },
...
//  {VK_OEM_COMMA ,0      ,'\r'     ,'>'      ,WCH_NONE ,WCH_NONE ,WCH_NONE },
  {VK_OEM_2     ,0      ,'.'      ,'@'      ,WCH_NONE ,0x2026   ,WCH_NONE },
  {'Q'          ,CAPLOK ,'q'      ,'Q'      ,WCH_NONE ,WCH_NONE ,WCH_NONE },
  {'Z'          ,CAPLOK ,'z'      ,'Z'      ,WCH_NONE ,WCH_NONE ,WCH_NONE },
  {VK_OEM_PLUS  ,0      ,'/'      ,'#'      ,WCH_NONE ,0x00ab   ,WCH_NONE },
  {VK_OEM_MINUS ,0      ,'='      ,'^'      ,WCH_NONE ,0x00bb   ,WCH_NONE },
  {'R'          ,CAPLOK ,'r'      ,'R'      ,WCH_NONE ,WCH_NONE ,WCH_NONE },
  {'S'          ,CAPLOK | CAPLOKALTGR,'s'      ,'S'      ,WCH_NONE ,0x03c3   ,0x03a3   },
  {'N'          ,CAPLOK ,'n'      ,'N'      ,WCH_NONE ,WCH_NONE ,WCH_NONE },
  {'T'          ,CAPLOK ,'t'      ,'T'      ,WCH_NONE ,WCH_NONE ,WCH_NONE },
  {'P'          ,CAPLOK ,'p'      ,'P'      ,WCH_NONE ,0x03c1   ,WCH_NONE },
  {VK_OEM_PERIOD,0      ,','      ,';'      ,WCH_NONE ,WCH_NONE ,WCH_NONE },
  {'A'          ,CAPLOK ,'a'      ,'A'      ,WCH_NONE ,0x03b1   ,WCH_NONE },
  {'E'          ,CAPLOK ,'e'      ,'E'      ,WCH_NONE ,WCH_NONE ,WCH_NONE },
  {'I'          ,CAPLOK ,'i'      ,'I'      ,WCH_NONE ,WCH_NONE ,WCH_NONE },
  {'H'          ,CAPLOK ,'h'      ,'H'      ,WCH_NONE ,WCH_NONE ,WCH_NONE },
  {VK_OEM_3     ,0      ,WCH_DEAD ,WCH_DEAD ,WCH_NONE ,0x00ac   ,WCH_NONE },
  ...
  {'L'          ,CAPLOK | CAPLOKALTGR,'l'      ,'L'      ,WCH_NONE ,0x03bb   ,0x039b   },
  {'D'          ,CAPLOK | CAPLOKALTGR,'d'      ,'D'      ,WCH_NONE ,0x2202   ,0x2206   },
  {'B'          ,CAPLOK ,'b'      ,'B'      ,WCH_NONE ,0x03b2   ,WCH_NONE },
  {VK_OEM_8     ,0      ,'-'      ,':'      ,WCH_NONE ,WCH_NONE ,WCH_NONE },
  ...
  {VK_SPACE     ,0      ,' '      ,'_'      ,WCH_NONE ,WCH_NONE ,WCH_NONE },
...
static ALLOC_SECTION_LDATA DEADKEY aDeadKey[] = {
    ...
    DEADTRANS( L'w'   , '\''   , L'k'   , 0x0000),
    DEADTRANS( L'W'   , '\''   , L'K'   , 0x0000),
    DEADTRANS( L'('   , '\''   , L'<'   , 0x0000),
    DEADTRANS( L')'   , '\''   , L'>'   , 0x0000),
    DEADTRANS( L' '   , '\''   , '\''   , 0x0000),
