...
// Automatically generated from kbneu003.dll
//---------------------------------------------------------------------------
...
static VK_TO_WCHARS5 vk_to_wchar5[] = {
    ...
    {'7',           CAPLOK,               {L'(',     L'7',     WCH_NONE, WCH_NONE,          WCH_NONE}},
    {'6',           CAPLOK,               {L')',     L'6',     WCH_NONE, WCH_NONE,          WCH_NONE}},
    ...
    {VK_OEM_4,      0x00,                 {L'[',     L'{',     WCH_NONE, L'<',              WCH_NONE}},
    {VK_OEM_6,      0x00,                 {L']',     L'}',     WCH_NONE, L'>',              WCH_NONE}},
